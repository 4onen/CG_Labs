...
bonobo::mesh_data createZoneplate(unsigned int width,
								  unsigned int height,
								  float wave_count = 1.0f,
								  float zplate_depth = 1.0f);

bonobo::mesh_data createOceanplate(unsigned int width, unsigned int height, float sideLength = 1.0f);
